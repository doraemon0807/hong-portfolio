...
export default function Home() {
  return (
    <div className="w-full h-screen grid grid-cols-2 items-center gap-x-0.5 px-20">
      <div className="place-self-center tracking-widest">
        ...
        <div className="text-2xl font-medium mt-10 flex">
          ...
          <ul className="relative font-semibold">
            <li className="animate-swapWordAnimation tracking-[2px] lg-1 absolute left-0">
              Fullstack
            </li>
            <li className="animate-swapWordAnimation absolute left-0 lg-1 animation-delay-3000">
              Frontend
            </li>
            <li className="animate-swapWordAnimation tracking-[3px] lg-1 absolute left-0 animation-delay-6000">
              Backend
            </li>
          </ul>
